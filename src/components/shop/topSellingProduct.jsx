...
function TopSellingProduct() {
  return (
    <div className="2xl:w-[452px] w-full min-h-[400px]  bg-softDark rounded-lg pl-[20px] shadow-sm ">
      <h2 className='py-[22px] font-[20px] text-secondary '>Top selling Products</h2>
